			...
			<div className="Igw0E rBNOH eGOV_ ybXk5 _4EzTm pjcA_">
                <div className="QzzMF Igw0E IwRSH eGOV_ vwCYk" data-testid="post-comment-root">
                    <span className="Jv7Aj mArmR MqpiF">
                        <a className="FPmhX notranslate MBL3Z" title="rudybundini" href="/rudybundini/" tabindex="0">rudybundini</a>
                    </span>&nbsp;
                        ...
                        <button className="wpO6b ZQScA" type="button" onClick={goodEvent}>
                            ...
                            <div className="QBdPU">
                                <span className="FY9nT">
                                    <svg aria-label="좋아요" className="_8-yf5 " fill="#262626" height="12" viewBox="0 0 48 48" width="12">
                            ...
                            <div className="QBdPU">
                                <span className="FY9nT">
                                    <svg aria-label="좋아요 취소" className="_8-yf5 " fill="#ed4956" height="12" viewBox="0 0 48 48" width="12">
