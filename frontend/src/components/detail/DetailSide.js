						...
						<div className="detail_side_content_root">
							...
							<div className="detail_side_content_footer_container">
								<div className="detail_side_content_footer_block">
									<time className="detail_side_content_footer_time" dateTime="2020-09-16T04:29:47.000Z" title="2020년 9월 16일">{timestamp}</time>	
								</div>
							</div>
						</div>
					</div>
...
const DetailSideCommnt = ({id, username, text, created_at, liked_count, imgurl}) => {
	return (
		<div className="detail_side_view_container">
							...
							<div className="detail_side_content_footer_container">
								<div className="detail_side_content_footer_block">
									<a className="detail_side_commnt_time_a">
										<time className="detail_side_content_footer_time" dateTime="2020-09-16T04:29:47.000Z" title="2020년 9월 16일">{created_at}</time>
									</a>
									<button className="detail_side_commnt_button">좋아요 {liked_count}개</button>
	...
	return (
		...
		<div className="detail_side_footer_time_container">
			<a className="detail_side_footer_time_a">
				<time className="detail_side_footer_time" dateTime="2020-11-29T15:30:24.000Z" title="2020년 11월 30일">{timestamp}</time>
			</a>
		</div>
		<section className="detail_side_footer_comment_input_container">
			<div className="detail_side_footer_comment_input_block">
				<form className="detail_side_footer_comment_input_form" method="POST">
					<textarea className="detail_side_footer_comment_input_textarea" ref={inputRef} aria-label="댓글 달기..." placeholder="댓글 달기..." autoComplete="off" autoCorrect="off"
						style={{"height": "18px"}}>
					</textarea>
		...
		<React.Fragment>
			<div className="detail_side_contents_container">
				<ul className="detail_side_contents_ul">
					<DetailSideContents username={props.data.username} text={props.data.text} timestamp={props.data.timestamp} imgurl={props.data.profile_img_url}/>
					{/*반복할 댓글*/}
					...
					<li>
						<div className="detail_side_commnts_view_more">
							<button className="detail_side_commnts_view_more_button">
								<span aria-label="댓글 더 읽어들이기" className="detail_side_commnts_view_more_glyphsSpriteCircle_add"></span>
							</button>
						</div>
					</li>
				</ul>
			</div>
			<DetailSideFooter like_count={props.data.preview_like} timestamp={props.data.timestamp}/>
		</React.Fragment>
	);
}
