		...
		<div className="COOzN MnWb5 YT6rB" style={style0}>
			<div className="m0NAq xrWdL">
				<div className="Igw0E IwRSH eGOV_ _4EzTm ItkAi" style={style1}>
					<div
						aria-labelledby="f1f0b0ecf6d6bc4 f18aa3255d64c48"
						className="Igw0E rBNOH eGOV_ ybXk5 _4EzTm"
					>
						<div className="Igw0E IwRSH eGOV_ _4EzTm yC0tu">
							<div
								className="RR-M- _2NjG_"
								aria-disabled="true"
								role="button"
								tabIndex="-1"
							>
						...
						<div className="Igw0E IwRSH YBx95 vwCYk">
							<div className="Igw0E IwRSH eGOV_ _4EzTm" id="f1f0b0ecf6d6bc4">
								<div className="_7UhW9 xLCgt MMzan KV-D4 fDxYl">
									<div className="Igw0E IwRSH eGOV_ ybXk5 vwCYk n4cjz">
										<a className="gmFkV" href="/is_yoon/" tabIndex="0">
											is_yoon
										</a>
									</div>
								</div>
							...
							<div
								className="Igw0E IwRSH eGOV_ _4EzTm DhRcB"
								id="f18aa3255d64c48"
							>
			...
			<div className="SkY6J">
				<nav className="uxKLF">
					<ul className="ixdEe _9Rlzb">
						...
						<li className="K5OFK">
							<a className="l93RR" href="https://help.instagram.com/">
								도움말
							</a>
						</li>
						<li className="K5OFK">
							<a className="l93RR" href="https://about.instagram.com/blog/">
								홍보 센터
							</a>
						</li>
						<li className="K5OFK">
							<a className="l93RR" href="/developer/">
								API
							</a>
						</li>
						<li className="K5OFK">
							<a className="l93RR" href="/about/jobs/">
								채용 정보
							</a>
						</li>
						<li className="K5OFK">
							<a className="l93RR" href="/legal/privacy/">
								개인정보처리방침
							</a>
						</li>
						<li className="K5OFK">
							<a className="l93RR _vfM2" href="/legal/terms/">
								약관
							</a>
						</li>
						<li className="K5OFK">
							<a className="l93RR" href="/explore/locations/">
								위치
							</a>
						</li>
						<li className="K5OFK">
							<a className="l93RR" href="/directory/profiles/">
								인기 계정
							</a>
						</li>
						<li className="K5OFK">
							<a className="l93RR" href="/directory/hashtags/">
								해시태그
							</a>
						</li>
						<li className="K5OFK">
							<span className="_3G4x7 tN4Ei l93RR">
								언어
